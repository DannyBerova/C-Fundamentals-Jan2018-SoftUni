namespace BashSoft
{
    ...
    public class CommandInterpreter
    {
        ...
        public void IntepredCommand(string input)
        {
            ...
            try
            {
                Command command = this.ParseCommand(input, commandNane, data);
                command.Execute();
            }
            catch (Exception ex)
            {
        ...
        private Command ParseCommand(string input, string command, string[] data)
        {
            switch (command)
            {
                ...
                // TODO: case "dec0rder": break;
                // TODO: case "download":TryDownloadRequestedFile(input, data); break;
                // TODO: case "downloadAsynch" TryDownloadRequestedFileAsync(input, data); break;
                default:
